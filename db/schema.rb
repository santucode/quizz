...
ActiveRecord::Schema[7.0].define(version: 2022_11_25_061335) do
  ...
  create_table "given_answers", force: :cascade do |t|
    ...
    t.index ["quiz_id"], name: "index_given_answers_on_quiz_id"
  ...
  add_foreign_key "given_answers", "questions"
  add_foreign_key "given_answers", "quizzes"
